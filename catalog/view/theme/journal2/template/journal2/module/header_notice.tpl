<div class="header-notice <?php echo $text_align; ?>-notice <?php echo $hide_on_mobile_class; ?> <?php echo $float_icon; ?> <?php echo $fullwidth; ?>" id="journal-header-notice-<?php echo $module; ?>" style="<?php echo $css; ?>">
