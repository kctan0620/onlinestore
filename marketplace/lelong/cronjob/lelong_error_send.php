<?php
	...
	include(dirname(__FILE__).'/../classes/lelong_error_log_queue.php');
    ...
    try{
		...
		$LelongQueue = new LelongErrorLogQueue($conn, $logger);
		...
		echo 'TMT-Error-Email-CronJobExceptionMessage: ' .$e->getMessage();
    }
