          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <input type="text" name="filter_name" id="filter_name" value="<?php echo $filter_name; ?>" placeholder="<?php echo $entry_name; ?>" id="input-name" class="form-control" />
              </div>              
            </div>  
            <div class="col-sm-4">
	            <div class="form-group">
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    <a href="<?php echo $sort_id; ?>" class="<?php echo strtolower($order); ?>"><?php echo ucfirst($column_id); ?></a>
                    <?php } else { ?>
