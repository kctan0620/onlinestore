...
class ModelLocalisationZone extends Model {
	...
	public function getZones($data = array()) {
		...
		// KC add on 19102015 for filter all the other than Malaysia zone
		$sql .= " WHERE z.status = 1 ";
	...
	public function getTotalZones() {
		...
		// KC add on 19102015 for filter all the other than Malaysia zone		
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "zone WHERE status = 1");
