...
class ControllerPaymentGHL extends Controller {
	...
	public function index() {
		$this->load->language('payment/ghl');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('payment/ghl', 'token=' . $this->session->data['token'], 'SSL'),      		
		);

		$data['action'] = $this->url->link('payment/ghl', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('payment/ghl.tpl', $data));
	}

	private function validate() {
		if (!$this->user->hasPermission('modify', 'payment/ghl')) {
