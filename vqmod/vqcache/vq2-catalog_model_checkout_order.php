...
class ModelCheckoutOrder extends Model {
	...
	public function addOrder($data) {
		...
		// added by KC - 10-09-2015 for TMT.MY - order number customisation
		$order_reference_prefix = 'TMT';
		$order_reference .= $order_reference_prefix.str_pad($order_id, 9, '0', STR_PAD_LEFT);
		$this->db->query("UPDATE " . DB_PREFIX . "order SET order_reference = '" . $order_reference . "' WHERE order_id = '" . (int)$order_id . "'");
	...
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				'order_reference'		  => $order_query->row['order_reference'],
	...
	public function addOrderHistory($order_id, $order_status_id, $comment = '', $notify = false) {
		...
		if ($order_info) {
			...
			'information'    => $this->getInfo($product['product_id'],$order_id,$order_info['language_id']), //$product['model'],
