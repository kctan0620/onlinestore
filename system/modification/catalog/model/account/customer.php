...
class ModelAccountCustomer extends Model {
	...
	public function getAddressByCustomer($customer_id) {
		$query = $this->db->query("SELECT *, zone.name as zone_name, country.name as country_name FROM " . DB_PREFIX . "address as address INNER JOIN ". DB_PREFIX . "zone as zone on zone.zone_id = address.zone_id INNER JOIN ". DB_PREFIX . "country as country on country.country_id = address.country_id WHERE customer_id = '" . $customer_id . "' limit 1");
