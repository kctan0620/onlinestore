...
class ControllerCatalogProduct extends Controller {
	...
	public function update() {
		...
		foreach ($this->request->post['selected'] as $product_id) {				
			...
			if (isset($this->request->post['status_id_'.$product_id])) {				
				$status_id = $this->request->post['status_id_'.$product_id];				
			}
			
			
			$this->model_catalog_product->updateProduct($product_id, $status_id);
		}
